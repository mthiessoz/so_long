...
/*   Updated: 2022/06/09 18:33:45 by mthiesso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	map_init(t_map *map)
{
	...
	map->cd_exit->img_name = mlx_xpm_file_to_image(map->mlx, map->cd_exit->img_path,
		&map->cd_exit->img_width, &map->cd_exit->img_height);
	map->op_exit->img_name = mlx_xpm_file_to_image(map->mlx, map->op_exit->img_path,
		&map->op_exit->img_width, &map->op_exit->img_height);
}
